...
<body>
    ...
    <main class="contaimer">
        ...
        <div class="container bg-warning p-4 rounded my-4">
            ...
            <form action="novo_chamado_cliente.php" method="post" enctype="multipart/form-data">
                <div class=" form-control  bg-secondary">
                    <div class="form-group">
                        <label class="h5" for="nome-hardware">Título do Problema:</label>
                        <input type="text" class="form-control" name="titulo" id="titulo" maxlength="30">
                    </div>

                    <div class="form-group">
                    <label class="h5 mt-2" for="nome-hardware">Qual o atual estado do seu equipamento?</label><br>
                    ...
                    <div class="form-group">
                    <label class="h5 mt-2" for="descricao">Descrição do Problema:</label><br>
                    <textarea class="form-control" name="descricao" id="descricao" rows="5" maxlength="500"></textarea>
                    </div>

                    <div class="form-group">
                    <label class="h5 mt-2" for="nome-hardware">Anexo:</label><br>
